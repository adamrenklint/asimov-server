...
module.exports = Base.extend({
  ...
  'initialize': function () {
    ...
    self.bindTo(asimov, 'public:serverVariables', 'transmitVariables');
  },
  ...
  'onMessage': function (data) {
    ...
    if (data.uid) return asimov.trigger('server:worker:message', data);
  ...
  'sendToWorker': function (payload) {

    var self = this;
    var worker = self.workers[payload.pid];
  ...
  'transmitVariables': function (name, data) {
